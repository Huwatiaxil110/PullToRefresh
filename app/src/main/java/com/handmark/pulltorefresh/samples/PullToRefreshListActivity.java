...
public final class PullToRefreshListActivity extends ListActivity {
	...
	static final int MENU_MANUAL_REFRESH = 0;	//手动刷新
	static final int MENU_DISABLE_SCROLL = 1;	//滚动时不能操作
	static final int MENU_SET_MODE = 2;			//改变操作模式（单双向的变化）
	static final int MENU_DEMO = 3;				//Demo
